...
type SGateData struct {
	...
	Counts   []*GateCount `protobuf:"bytes,2,rep,name=counts" json:"counts,omitempty"`
...
func (m *SGateData) GetCounts() []*GateCount {
	if m != nil {
		return m.Counts
	}
	return nil
...
func (this *SGateData) Equal(that interface{}) bool {
	...
	for i := range this.Counts {
		if !this.Counts[i].Equal(that1.Counts[i]) {
			return false
		}
	}
	if this.Error != that1.Error {
...
func (this *SGateData) String() string {
	...
	s := strings.Join([]string{`&SGateData{`,
		...
		`Counts:` + strings.Replace(fmt.Sprintf("%v", this.Counts), "GateCount", "GateCount", 1) + `,`,
		`Error:` + fmt.Sprintf("%v", this.Error) + `,`,
		`}`,
	}, "")
	return s
...
func (m *SGateData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Counts = append(m.Counts, &GateCount{})
...
var fileDescriptorGameUser = []byte{
	...
	,
}
